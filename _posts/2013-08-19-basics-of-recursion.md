...
Remember that it doesn't matter which comes first if the values are equal, thus you can simply use an else clause instead of checking if the value is more.<br/>
