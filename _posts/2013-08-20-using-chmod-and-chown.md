...
excerpt: "Learn how to use chown and chmod to change file permissions and ownership on Unix/Linux based systems."
category: howto
tags: [linux,os,unix,terminal]
comments: true
image:
   feature: Using chmod and chown.jpg
   thumb:
---
